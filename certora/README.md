...
To run rules we use the script PatchAndCertoraRun.sh in certora/scripts with the name of a configuration file from certora/confs, for example 

```
certora/scripts/PatchAndCertoraRun.sh Range.conf
```
